...
<?php } ?>
	...
	<link rel="stylesheet" href="//pokemonshowdown.com/theme/panels.css?0.7924011667324664" />
	<link rel="stylesheet" href="//pokemonshowdown.com/theme/main.css?0.8399971104506507" />
	...
	<div class="pfx-topbar">
		<div class="header">
			<ul class="nav">
				<li><a class="button nav-first<?php if ($panels->tab === 'home') echo ' cur'; ?>" href="//pokemonshowdown.com/?0.1717453452547837"><img src="//pokemonshowdown.com/images/pokemonshowdownbeta.png?0.40412858900049664" alt="Pok&eacute;mon Showdown! (beta)" /> Home</a></li>
				<li><a class="button<?php if ($panels->tab === 'pokedex') echo ' cur'; ?>" href="//dex.pokemonshowdown.com/?0.8793093774460585">Pok&eacute;dex</a></li>
				<li><a class="button<?php if ($panels->tab === 'replay') echo ' cur'; ?>" href="/?0.10720760986286693">Replays</a></li>
				<li><a class="button<?php if ($panels->tab === 'ladder') echo ' cur'; ?>" href="//pokemonshowdown.com/ladder/?0.07362519609701579">Ladder</a></li>
				<li><a class="button nav-last" href="//pokemonshowdown.com/forums/?0.36103598296940165">Forum</a></li>
			</ul>
...
?>
	...
	<script src="//dex.pokemonshowdown.com/js/panels.js?0.2358404860939607"></script>
<?php
}
...
<?php $panels->scripts(); ?>
	...
	<script src="//play.pokemonshowdown.com/config/config.js?3db2b231"></script>
	...
	<script src="//play.pokemonshowdown.com/data/pokedex.js?cbfe6772"></script>
	...
	<script src="//play.pokemonshowdown.com/data/teambuilder-tables.js?ef66565d"></script>
