...
<?php } ?>
	...
	<link rel="stylesheet" href="//pokemonshowdown.com/theme/panels.css?0.5597898406176465" />
	<link rel="stylesheet" href="//pokemonshowdown.com/theme/main.css?0.19511571059406996" />
	...
	<div class="pfx-topbar">
		<div class="header">
			<ul class="nav">
				<li><a class="button nav-first<?php if ($panels->tab === 'home') echo ' cur'; ?>" href="//pokemonshowdown.com/?0.4496449875852033"><img src="//pokemonshowdown.com/images/pokemonshowdownbeta.png?0.8589462427576007" alt="Pok&eacute;mon Showdown! (beta)" /> Home</a></li>
				<li><a class="button<?php if ($panels->tab === 'pokedex') echo ' cur'; ?>" href="//dex.pokemonshowdown.com/?0.0053282574034245744">Pok&eacute;dex</a></li>
				<li><a class="button<?php if ($panels->tab === 'replay') echo ' cur'; ?>" href="/?0.7329695676987626">Replays</a></li>
				<li><a class="button<?php if ($panels->tab === 'ladder') echo ' cur'; ?>" href="//pokemonshowdown.com/ladder/?0.9253114862944927">Ladder</a></li>
				<li><a class="button nav-last" href="//pokemonshowdown.com/forums/?0.29721845468972496">Forum</a></li>
			</ul>
...
?>
	...
	<script src="//dex.pokemonshowdown.com/js/panels.js?0.7565461511730271"></script>
<?php
}
...
<?php $panels->scripts(); ?>
	...
	<script src="//play.pokemonshowdown.com/config/config.js?9c5ff44b"></script>
	...
	<script src="//play.pokemonshowdown.com/data/pokedex.js?0ac24777"></script>
	...
	<script src="//play.pokemonshowdown.com/data/teambuilder-tables.js?71ba646f"></script>
