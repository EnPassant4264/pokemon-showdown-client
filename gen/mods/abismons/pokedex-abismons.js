"use strict";Object.defineProperty(exports, "__esModule", {value: true}); const Pokedex = {
	...
	charizardmegaxabismons: {
		num: 6,
		name: "Charizard-Mega-X-Abismons",
	...
	charizardmegayabismons: {
		num: 6,
		name: "Charizard-Mega-Y-Abismons",
		baseSpecies: "Charizard",
		forme: "Mega-Y",
		types: ["Fire", "Flying"],
		genderRatio: {M: 0.875, F: 0.125},
	...
	raticatealolatotemabismons: {
		num: 20,
		name: "Raticate-Alola-Totem-Abismons",
		baseSpecies: "Raticate",
		forme: "Alola-Totem",
		types: ["Dark", "Normal"],
		baseStats: {hp: 75, atk: 71, def: 70, spa: 40, spd: 80, spe: 77},
	...
	pikachurockstarabismons: {
		num: 25,
		name: "Pikachu-Rock-Star-Abismons",
		baseSpecies: "Pikachu",
		forme: "Rock-Star",
		types: ["Electric"],
		gender: "F",
	...
	pikachupopstarabismons: {
		num: 25,
		name: "Pikachu-Pop-Star-Abismons",
		baseSpecies: "Pikachu",
		forme: "Pop-Star",
		types: ["Electric"],
		gender: "F",
	...
	pikachuoriginalabismons: {
		num: 25,
		name: "Pikachu-Original-Abismons",
		baseSpecies: "Pikachu",
		forme: "Original",
		types: ["Electric"],
		gender: "M",
	...
	sandslashmegaabismons: {
		num: 28,
		name: "Sandslash-Mega-Abismons",
		forme: "Mega",
		types: ["Ground", "Bug"],
	...
	farfetchdgalarabismons: {
		num: 83,
		name: "Farfetch\u2019d-Galar-Abismons",
	...
	electrodemegaabismons: {
		num: 1356,
		name: "Electrode-Mega-Abismons",
	...
	marowakalolatotemabismons: {
		num: 105,
		name: "Marowak-Alola-Totem-Abismons",
		baseSpecies: "Marowak",
		forme: "Alola-Totem",
		types: ["Fire", "Ghost"],
		baseStats: {hp: 60, atk: 80, def: 110, spa: 50, spd: 80, spe: 45},
	...
	pichuspikyearedabismons: {
		num: 172,
		name: "Pichu-Spiky-eared-Abismons",
		baseSpecies: "Pichu",
		forme: "Spiky-eared",
		types: ["Electric"],
		baseStats: {hp: 20, atk: 40, def: 15, spa: 35, spd: 35, spe: 60},
	...
	wailordmegagulpingabismons: {
		num: 321,
		forme: "Mega",
		name: "Wailord-Mega-Gulping-Abismons",
		types: ["Water"],
		baseStats: {hp: 170, atk: 140, def: 65, spa: 100, spd: 65, spe: 60},
		abilities: {0: "Gulp Missile 2"},
		heightm: 20.6,
	...
	wailordmegamendingabismons: {
		num: 321,
		forme: "Mega",
		name: "Wailord-Mega-Mending-Abismons",
		types: ["Water"],
		baseStats: {hp: 170, atk: 140, def: 65, spa: 100, spd: 65, spe: 60},
		abilities: {0: "Gulp Missile 2"},
		heightm: 20.6,
	...
	cherrimsunshineabismons: {
		num: 421,
		name: "Cherrim-Sunshine-Abismons",
		baseSpecies: "Cherrim",
		forme: "Sunshine",
		types: ["Grass", "Fairy"],
	...
	basculinbluestripedabismons: {
		num: 550,
		name: "Basculin-Blue-Striped-Abismons",
	...
	darmanitanzenabismons: {
		num: 555,
		name: "Darmanitan-Zen-Abismons",
	...
	darmanitangalarabismons: {
		num: 555,
		name: "Darmanitan-Galar-Abismons",
		baseSpecies: "Darmanitan",
		forme: "Galar",
		types: ["Ice"],
		baseStats: {hp: 105, atk: 140, def: 55, spa: 30, spd: 55, spe: 95},
	...
	darmanitangalarzenabismons: {
		num: 555,
		name: "Darmanitan-Galar-Zen-Abismons",
		baseSpecies: "Darmanitan",
		forme: "Galar-Zen",
		types: ["Ice", "Fire"],
	...
	tornadustherianabismons: {
		num: 641,
		name: "Tornadus-Therian-Abismons",
	...
	thundurustherianabismons: {
		num: 642,
		name: "Thundurus-Therian-Abismons",
	...
	landorustherianabismons: {
		num: 645,
		name: "Landorus-Therian-Abismons",
	...
	meloettapirouetteabismons: {
		num: 648,
		name: "Meloetta-Pirouette-Abismons",
	...
	vivillonpokeballabismons: {
		num: 666,
		name: "Vivillon-Pokeball-Abismons",
		baseSpecies: "Vivillon",
		forme: "Pokeball",
		types: ["Bug", "Flying"],
		baseStats: {hp: 80, atk: 52, def: 50, spa: 90, spd: 50, spe: 89},
	...
	zygardecompleteabismons: {
		num: 718,
		name: "Zygarde-Complete-Abismons",
		baseSpecies: "Zygarde",
		forme: "Complete",
		types: ["Dragon", "Ground"],
		gender: "N",
	...
	hoopaunboundmegaabismons: {
		num: 720,
		name: "Hoopa-Unbound-Mega-Abismons",
	...
	oricoriopompomabismons: {
		num: 741,
		name: "Oricorio-Pom-Pom-Abismons",
	...
	lycanrocmidnightabismons: {
		num: 745,
		name: "Lycanroc-Midnight-Abismons",
	...
	wishiwashischoolabismons: {
		num: 746,
		name: "Wishiwashi-School-Abismons",
	...
	silvallyelectricabismons: {
		num: 773,
		name: "Silvally-Electric-Abismons",
		baseSpecies: "Silvally",
		forme: "Electric",
		types: ["Electric"],
		gender: "N",
	...
	silvallyfightingabismons: {
		num: 773,
		name: "Silvally-Fighting-Abismons",
		baseSpecies: "Silvally",
		forme: "Fighting",
		types: ["Fighting"],
		gender: "N",
	...
	silvallymegaabismons: {
		num: 1450,
		name: "Silvally-Mega-Abismons",
		baseSpecies: "Silvally",
		forme: "Mega",
		types: ["Normal"],
		genderRatio: {M: 0.875, F: 0.125},
	...
	silvallypsychicabismons: {
		num: 773,
		name: "Silvally-Psychic-Abismons",
		baseSpecies: "Silvally",
		forme: "Psychic",
		types: ["Psychic"],
		gender: "N",
	...
	togedemarutotemabismons: {
		num: 777,
		name: "Togedemaru-Totem-Abismons",
	...
	mimikyubustedabismons: {
		num: 778,
		name: "Mimikyu-Busted-Abismons",
		baseSpecies: "Mimikyu",
		forme: "Busted",
		types: ["Ghost", "Fairy"],
		baseStats: {hp: 55, atk: 90, def: 80, spa: 50, spd: 105, spe: 96},
	...
	mimikyubustedtotemabismons: {
		num: 778,
		name: "Mimikyu-Busted-Totem-Abismons",
		baseSpecies: "Mimikyu",
		forme: "Busted-Totem",
		types: ["Ghost", "Fairy"],
		baseStats: {hp: 55, atk: 90, def: 80, spa: 50, spd: 105, spe: 96},
	...
	necrozmaduskmaneabismons: {
		num: 800,
		name: "Necrozma-Dusk-Mane-Abismons",
	...
	necrozmadawnwingsabismons: {
		num: 800,
		name: "Necrozma-Dawn-Wings-Abismons",
		baseSpecies: "Necrozma",
		forme: "Dawn-Wings",
		types: ["Psychic", "Ghost"],
		gender: "N",
	...
	magearnaoriginalabismons: {
		num: 801,
		name: "Magearna-Original-Abismons",
	...
	corviknightgmaxabismons: {
		num: 823,
		name: "Corviknight-Gmax-Abismons",
	...
	cramorantgulpingabismons: {
		num: 845,
		name: "Cramorant-Gulping-Abismons",
	...
	cramorantgorgingabismons: {
		num: 845,
		name: "Cramorant-Gorging-Abismons",
		baseSpecies: "Cramorant",
		forme: "Gorging",
		types: ["Flying", "Water"],
		baseStats: {hp: 70, atk: 85, def: 55, spa: 85, spd: 95, spe: 85},
	...
	toxtricitylowkeyabismons: {
		num: 849,
		name: "Toxtricity-Low-Key-Abismons",
	...
	toxtricitylowkeygmaxabismons: {
		num: 849,
		name: "Toxtricity-Low-Key-Gmax-Abismons",
		baseSpecies: "Toxtricity",
		forme: "Low-Key-Gmax",
		types: ["Electric", "Poison"],
		baseStats: {hp: 75, atk: 98, def: 70, spa: 114, spd: 70, spe: 75},
	...
	centiskorchgmaxabismons: {
		num: 851,
		name: "Centiskorch-Gmax-Abismons",
	...
	sinisteaantiqueabismons: {
		num: 854,
		name: "Sinistea-Antique-Abismons",
	...
	polteageistantiqueabismons: {
		num: 855,
		name: "Polteageist-Antique-Abismons",
	...
	morpekohangryabismons: {
		num: 877,
		name: "Morpeko-Hangry-Abismons",
		baseSpecies: "Morpeko",
		forme: "Hangry",
		types: ["Electric", "Dark"],
		baseStats: {hp: 58, atk: 95, def: 58, spa: 70, spd: 58, spe: 97},
	...
	zamazentacrownedabismons: {
		num: 889,
		name: "Zamazenta-Crowned-Abismons",
	...
	eternatuseternamaxabismons: {
		num: 890,
		name: "Eternatus-Eternamax-Abismons",
	...
	urshifurapidstrikeabismons: {
		num: 892,
		name: "Urshifu-Rapid-Strike-Abismons",
		baseSpecies: "Urshifu",
		forme: "Rapid-Strike",
	...
	urshifurapidstrikegmaxabismons: {
		num: 892,
		name: "Urshifu-Rapid-Strike-Gmax-Abismons",
		baseSpecies: "Urshifu",
	...
	pokestarsmeargleabismons: {
		num: -5000,
		name: "Pokestar Smeargle-Abismons",
		types: ["Normal"],
		baseStats: {hp: 55, atk: 20, def: 35, spa: 20, spd: 45, spe: 75},
		abilities: {0: "Own Tempo", 1: "Technician", H: "Moody"},
		heightm: 1.5,
	...
	pokestarbrycenmanabismons: {
		num: -5002,
		name: "Pokestar Brycen-Man-Abismons",
		types: ["Dark", "Psychic"],
		gender: "M",
		baseStats: {hp: 100, atk: 100, def: 100, spa: 100, spd: 100, spe: 100},
		abilities: {0: "Levitate"},
	...
	pokestartransportabismons: {
		num: -5005,
		name: "Pokestar Transport-Abismons",
		types: ["Steel"],
		gender: "N",
		baseStats: {hp: 100, atk: 100, def: 100, spa: 100, spd: 100, spe: 100},
	...
	pokestarhumanoidabismons: {
		num: -5007,
		name: "Pokestar Humanoid-Abismons",
		types: ["Normal"],
		baseStats: {hp: 100, atk: 100, def: 100, spa: 100, spd: 100, spe: 100},
		abilities: {0: "Insomnia"},
		heightm: 1.5,
	...
	pokestarmonsterabismons: {
		num: -5008,
		name: "Pokestar Monster-Abismons",
		types: ["Dark"],
		baseStats: {hp: 100, atk: 100, def: 100, spa: 100, spd: 100, spe: 100},
		abilities: {0: "Pressure"},
		heightm: 1.5,
	...
	pokestarblackdoorabismons: {
		num: -5012,
		name: "Pokestar Black Door-Abismons",
		types: ["Grass"],
		gender: "F",
		baseStats: {hp: 100, atk: 100, def: 100, spa: 100, spd: 100, spe: 100},
	...
	pokestarwhitedoorabismons: {
		num: -5013,
		name: "Pokestar White Door-Abismons",
		types: ["Fire"],
		gender: "M",
		baseStats: {hp: 100, atk: 100, def: 100, spa: 100, spd: 100, spe: 100},
		abilities: {0: "Blaze"},
	...
	pokestarblackbeltabismons: {
		num: -5014,
		name: "Pokestar Black Belt-Abismons",
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 100, atk: 100, def: 100, spa: 100, spd: 100, spe: 100},
		abilities: {0: "Huge Power"},
	...
	pokestarufopropu2abismons: {
		num: -5001,
		name: "Pokestar UFO-PropU2-Abismons",
		baseSpecies: "Pokestar UFO",
		forme: "PropU2",
		types: ["Psychic", "Electric"],
		gender: "N",
	...
	ulteusmachinaabismons: {
		num: 1267,
		name: "Ulteus-Machina-Abismons",
		baseSpecies: "Ulteus",
		forme: "Machina",
		types: ["Electric", "Steel"],
		gender: "N",
	...
	darknebulafrostabismons: {
		num: 1269,
		name: "Dark Nebula-Frost-Abismons",
	...
	darknebulateslaabismons: {
		num: 1269,
		name: "Dark Nebula-Tesla-Abismons",
		baseSpecies: "Dark Nebula",
		forme: "Tesla",
		types: ["Electric", "Ghost"],
		baseStats: {hp: 80, atk: 100, def: 130, spa: 140, spd: 160, spe: 80},
