...
*/
	...
	*/
	...
	modeshift: {
		...
		onModifyPriority(priority, pokemon, target, move) {
			if (_optionalChain([move, 'optionalAccess', _4 => _4.category]) === 'Status') {
				move.pranksterBoosted = true;
				return priority + 1;
			}
		},
	...
	battletheme: {
		...
		onModifyMove(move) {
			...
			if (_optionalChain([move, 'access', _5 => _5.self, 'optionalAccess', _6 => _6.chance])) move.self.chance *= 2;
		},
		isPermanent: true,
		name: "Battle Theme",
	...
	flashyjokes: {
		...
		onModifyPriority(priority, pokemon, target, move) {
			if (_optionalChain([move, 'optionalAccess', _7 => _7.category]) === 'Status') {
				move.pranksterBoosted = true;
				return priority + 1;
			}
		},
	...
	fairygust: {
		...
		onModifyPriority(priority, pokemon, target, move) {
			if (_optionalChain([move, 'optionalAccess', _8 => _8.type]) === 'Flying' && pokemon.hp === pokemon.maxhp) return priority + 1;
		},
		name: "Fairy Gust",
...
*/
	...
	lighthearted: {
		onModifyPriority(priority, pokemon, target, move) {
			if (_optionalChain([move, 'optionalAccess', _10 => _10.category]) === 'Status') {
				move.pranksterBoosted = true;
				return priority + 1;
			}
		},
