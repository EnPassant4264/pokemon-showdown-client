	...
	pokemon: {
        ...
        ignoringAbility() {
            ...
            return !!(
                ...
                ((this.volatiles['gastroacid'] || (neutralizinggas && this.ability !== ('neutralizinggas' )) || (lemegeton && this.ability !== ('lemegeton' )) ) &&
        ...
        ignoreImmunities = false
			  ...
			  if (this.status === status.id) {
					if (_optionalChain([(sourceEffect ), 'optionalAccess', _3 => _3.status]) === this.status) {
						 this.battle.add('-fail', this, this.status);
					} else if (_optionalChain([(sourceEffect ), 'optionalAccess', _4 => _4.status])) {
			  ...
			  if (!ignoreImmunities && status.id &&
						 !(_optionalChain([source, 'optionalAccess', _5 => _5.hasAbility, 'call', _6 => _6(['corrosion', 'toxicplay'])]) && ['tox', 'psn'].includes(status.id))) {
