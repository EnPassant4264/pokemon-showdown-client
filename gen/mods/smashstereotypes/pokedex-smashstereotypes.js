"use strict";Object.defineProperty(exports, "__esModule", {value: true}); const Pokedex = {
	...
	kokovoirmegasmashstereotypes: {
		fusion: ['Gardevoir', 'Tapu Koko'],
		num: 6,
		name: "Kokovoir-Mega-Smashstereotypes",
	...
	salaossmashstereotypes: {
		num: 7,
		name: "Salaos-Smashstereotypes",
		types: ["Dark"],
	...
	machampsmashstereotypes: {
		inherit: true,
		num: 8,
		otherFormes: ["Machamp-Mega"],
		formeOrder: ["Machamp", "Machamp-Mega"],
	},
	machampmegasmashstereotypes: {
		num: 8,
		name: "Machamp-Mega-Smashstereotypes",
		baseSpecies: "Machamp",
		forme: "Mega",
		types: ["Fighting"],
	...
	machampindiasmashstereotypes: {
		num: 9,
		name: "Machamp-India-Smashstereotypes",
		types: ["Psychic"],
	...
	sandacondasmashstereotypes: {
		num: 10,
		name: "Sandaconda-Smashstereotypes",
		baseForme: "Coiled",
		types: ["Ground"],
	...
	sandacondauncoiledsmashstereotypes: {
		num: 10,
		name: "Sandaconda-Uncoiled-Smashstereotypes",
	...
	cummulussmashstereotypes: {
		num: 11,
		name: "Cummulus-Smashstereotypes",
		types: ["Flying"],
		gender: "M",
	...
	silvallyrocksmashstereotypes: {
		num: 12,
		name: "Silvally-Rock-Smashstereotypes",
		types: ["Rock"],
		gender: "N",
	...
	pincurchinsmashstereotypes: {
		num: 13,
		name: "Pincurchin-Smashstereotypes",
		types: ["Electric"],
		baseStats: {hp: 111, atk: 72, def: 75, spa: 98, spd: 108, spe: 51},
		abilities: {0: "Iron Barbs", H: "Lightning Rod"},
		weightkg: 1,
	},
	spectriersmashstereotypes: {
		num: 14,
		name: "Spectrier-Smashstereotypes",
		types: ["Ghost"],
		gender: "N",
	...
	chillytesmashstereotypes: {
		num: 15,
		name: "Chillyte-Smashstereotypes",
		types: ["Ice"],
	...
	chillytemegasmashstereotypes: {
		num: 15,
		name: "Chillyte-Mega-Smashstereotypes",
	...
	magroachsmashstereotypes: {
		num: 16,
		name: "Magroach-Smashstereotypes",
		types: ["Bug"],
	...
	exploudsmashstereotypes: {
		inherit: true,
		num: 17,
		otherFormes: ["Exploud-Meow"],
		formeOrder: ["Exploud", "Exploud-Meow"],
	},
	exploudmeowsmashstereotypes: {
		num: 17,
		name: "Exploud-Meow-Smashstereotypes",
		baseSpecies: "Exploud",
	...
	garbodorsmashstereotypes: {
		inherit: true,
		otherFormes: ["Garbodor-Gmax"],
		formeOrder: ["Garbodor", "Garbodor-Gmax"],
	},
	garbodorgmaxsmashstereotypes: {
		num: 18,
		name: "Garbodor-Gmax-Smashstereotypes",
	...
	grimmsnarlsmashstereotypes: {
		inherit: true,
		otherFormes: ["Grimmsnarl-Alola"],
		formeOrder: ["Grimmsnarl", "Grimmsnarl-Alola"],
	},
	grimmsnarlalolasmashstereotypes: {
		num: 19,
		name: "Grimmsnarl-Alola-Smashstereotypes",
	...
	peasmakersmashstereotypes: {
		num: 20,
		name: "Peasmaker-Smashstereotypes",
		types: ["Grass", "Flying"],
	...
	peasmakermegasmashstereotypes: {
		num: 20,
		name: "Peasmaker-Mega-Smashstereotypes",
	...
	cofazorsmashstereotypes: {
		fusion: ['Cofagrigus', 'Scizor'],
		num: 21,
		name: "Cofazor-Smashstereotypes",
		types: ["Ghost", "Steel"],
	...
	cofazormegasmashstereotypes: {
		fusion: ['Cofagrigus', 'Scizor'],
		num: 21,
		name: "Cofazor-Mega-Smashstereotypes",
		baseSpecies: "Cofazor",
		forme: "Mega",
		types: ["Ghost", "Steel"],
