"use strict";Object.defineProperty(exports, "__esModule", {value: true}); const Pokedex = {
	clefabledoeppelgangers: {
		inherit: true,
		otherFormes: ["Anti-Clefable"],
		formeOrder: ["Clefable", "Anti-Clefable"],
	},
	anticlefabledoeppelgangers: {
		num: 36,
		name: "Anti-Clefable-Doeppelgangers",
	...
	dragonitedoeppelgangers: {
		inherit: true,
		otherFormes: ["Anti-Dragonite"],
		formeOrder: ["Dragonite", "Anti-Dragonite"],
	},
	antidragonitedoeppelgangers: {
		num: 149,
		name: "Dragonite-Doeppelgangers",
	...
	blisseydoeppelgangers: {
		inherit: true,
		otherFormes: ["Anti-Blissey"],
		formeOrder: ["Blissey", "Anti-Blissey"],
	},
	antiblisseydoeppelgangers: {
		num: 242,
		name: "Anti-Blissey-Doeppelgangers",
		baseSpecies: "Blissey",
		forme: "Anti",
		types: ["Ghost", "Electric"],
		gender: "F",
	...
	swampertdoeppelgangers: {
		inherit: true,		
		otherFormes: ["Anti-Swampert"],
		formeOrder: ["Swampert", "Anti-Swampert"],
	},
	antiswampertdoeppelgangers: {
		num: 260,
		name: "Anti-Swampert-Doeppelgangers",
	...
	garchompdoeppelgangers: {
		inherit: true,
		otherFormes: ["Anti-Garchomp"],
		formeOrder: ["Garchomp", "Anti-Garchomp"],
	},
	antigarchompdoeppelgangers: {
		num: 445,
		name: "Anti-Garchomp-Doeppelgangers",
	...
	ferrothorndoeppelgangers: {
		inherit: true,
		otherFormes: ["Anti-Ferrothorn"],
		formeOrder: ["Ferrothorn", "Anti-Ferrothorn"],
	},
	antiferrothorndoeppelgangers: {
		num: 598,
		name: "Anti-Ferrothorn-Doeppelgangers",
	...
	toxapexdoeppelgangers: {
		inherit: true,
		otherFormes: ["Anti-Toxapex"],
		formeOrder: ["Toxapex", "Anti-Toxapex"],
	},
	antitoxapexdoeppelgangers: {
		num: 748,
		name: "Anti-Toxapex-Doeppelgangers",
		baseSpecies: "Toxapex",
		forme: "Anti",
		types: ["Poison", "Ground"],
	...
	tapukokodoeppelgangers: {
		inherit: true,
		otherFormes: ["Anti-Tapu Koko"],
		formeOrder: ["Tapu Koko", "Anti-Tapu Koko"],
	},
	antitapukokodoeppelgangers: {
		num: 785,
		name: "Tapu Koko-Doeppelgangers",
	...
	kartanadoeppelgangers: {
		inherit: true,
		otherFormes: ["Anti-Kartana"],
		formeOrder: ["Kartana", "Anti-Kartana"],
	},
	antikartanadoeppelgangers: {
		num: 798,
		name: "Anti-Kartana-Doeppelgangers",
		baseSpecies: "Kartana",
		forme: "Anti",
	...
	arctozoltdoeppelgangers: {
		inherit: true,
		otherFormes: ["Anti-Arctozolt"],
		formeOrder: ["Arctozolt", "Anti-Arctozolt"],
	},
	antiarctozoltdoeppelgangers: {
		num: 881,
		name: "Anti-Arctozolt-Doeppelgangers",
